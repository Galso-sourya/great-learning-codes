import {useEffect,useReducer,cloneElement,ReactElement,Reducer} from 'react';
type Props={
    children:ReactElement[]
};
type Action={type:'PREVIOUS_SLIDE'} |
{type:'NEXT_SLIDE'} |
...
<button onClick={()=>dispatch({type:'PREVIOUS_SLIDE'})}>previous</button>
